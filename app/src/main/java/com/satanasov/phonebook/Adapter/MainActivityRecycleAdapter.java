...
public class MainActivityRecycleAdapter extends RecyclerView.Adapter<MainActivityRecycleAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void goToContactsActivity(Utils.ChangeOptions option, int position) {
            ...
            intent.putExtra(Utils.IntentKeys.OPTION.name(), option);
            intent.putExtra(Utils.IntentKeys.CONTACT.name(), user);
